...
var convE2eeById = {};       // convId -> bool: conversation-level E2EE flag (migration 018)
var currentConvE2ee = false; // the open conversation's flag, drives the send path + lock button
