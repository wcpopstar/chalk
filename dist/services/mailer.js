    ...
    if (!config.smtp.host) {
        ...
        transporter = {
            sendMail: async (opts) => {
                ...
                logger.info({ to: opts.to, subject: opts.subject, text: opts.text }, '📧 DEV MAIL — no SMTP configured, printing instead');
...
async function sendPasswordResetEmail(to, resetUrl) {
    ...
    await t.sendMail({
        ...
        text: 'Мы получили запрос на сброс пароля для твоего аккаунта Chalk.\n\n' +
        ...
        html: `<div style="font-family:sans-serif;font-size:14px;line-height:1.6;color:#111">` +
