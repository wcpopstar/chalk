 ...
 */
router.get('/history', requireAuth, historyLimiter, validate({ query: historyQuerySchema }), async (req, res) => {
 ...
 *             schema: { $ref: '#/components/schemas/Error' }
 */
router.post('/record-call', requireAuth, writeLimiter, validate({ body: recordCallSchema }), async (req, res) => {
 ...
 *             schema: { $ref: '#/components/schemas/Error' }
 */
router.post('/:matchId/rate', requireAuth, writeLimiter, validate({ params: uuidParam('matchId'), body: rateMatchSchema }), async (req, res) => {
