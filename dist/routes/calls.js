...
router.post('/start', requireAuth, callLimiter, validate({ body: startCallSchema }), async (req, res) => {
 ...
 *             schema: { $ref: '#/components/schemas/Error' }
 */
router.patch('/:id/end', requireAuth, callLimiter, validate({ params: uuidParam(), body: endCallSchema }), async (req, res) => {
