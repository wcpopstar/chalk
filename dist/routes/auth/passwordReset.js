 ...
 */
router.post('/forgot-password', authLimiter, forgotPasswordEmailLimiter, validate({ body: forgotPasswordSchema }), async (req, res) => {
 ...
 *             schema: { $ref: '#/components/schemas/Error' }
 */
router.post('/reset-password', authLimiter, validate({ body: resetPasswordSchema }), async (req, res) => {
