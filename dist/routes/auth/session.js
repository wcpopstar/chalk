...
const { rotateRefreshToken, revokeRefreshToken, revokeAllForUser, InvalidRefreshTokenError, TokenReuseError, } = require('../../services/refreshTokens');
 ...
 */
router.post('/logout', optionalAuth, sessionActionLimiter, async (req, res) => {
    const { refreshToken } = req.body || {};
    if (refreshToken && typeof refreshToken === 'string') {
 ...
 *             schema: { $ref: '#/components/schemas/Error' }
 */
router.post('/logout-all', requireAuth, sessionActionLimiter, async (req, res) => {
 ...
 *             schema: { $ref: '#/components/schemas/Error' }
 */
router.get('/me', requireAuth, sessionActionLimiter, async (req, res) => {
