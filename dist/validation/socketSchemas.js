...
const isBinaryLike = (v) => (Buffer.isBuffer(v) || v instanceof Uint8Array || v instanceof ArrayBuffer) &&
    (v.byteLength ?? v.length ?? 0) <= MAX_MEDIA_BYTES;
...
const messageText = (max) => z.string().trim().min(1).max(max);
...
//# sourceMappingURL=socketSchemas.js.map