 ...
 */
const FULL_PROFILE_FIELDS = 'id, username, email, country, languages, avatar_emoji, avatar_url, age, gender, onboarding_completed, presence, created_at';
// ── register.js ──────────────────────────────────────────────────────────
function existsByEmailOrUsername(email, username) {
...
function createUser(record, selectFields = FULL_PROFILE_FIELDS) {
...
// ── passwordReset.js ─────────────────────────────────────────────────────
function findByEmailForPasswordReset(email) {
...
// ── users/profile.js ──────────────────────────────────────────────────────
function existsByUsernameExcludingId(username, excludeUserId) {
    return supabaseAdmin
        .from('users')
        .select('id')
...
function updateProfile(userId, updates, selectFields) {
...
function findDiscoverCandidates({ excludeIds, gameFilterIds, limit }) {
...
function findByUsernameExact(username, excludeUserId) {
    return supabaseAdmin
        .from('users')
...
function searchByUsername(likePattern, excludeUserId, limit) {
    return supabaseAdmin
        .from('users')
        .select('id, username, avatar_emoji, avatar_url, status, presence')
...
function findPublicProfileById(userId) {
    return supabaseAdmin
        .from('users')
        .select(`id, username, country, languages, avatar_emoji, avatar_url, age, gender, bio, status, presence, last_seen,
