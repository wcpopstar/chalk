...
const { isFlooding, isFloodingUser, isFloodingGlobal, checkNamedLimit, } = require('./rateLimit');
...
function disconnectForRateLimit(socket, details) {
...
async function socketConnectionRateLimiter(socket, next) {
